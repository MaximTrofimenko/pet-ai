package com.trofimenko.petai.advisors.expansion;
...
public class ExpansionQueryAdvisor implements BaseAdvisor {
    ...
    private static final PromptTemplate template = PromptTemplate.builder()
            .template("""
                    ...
                    "что такое питон" -> "что такое питон язык программирования Python"
    ...
    public ChatClientRequest before(ChatClientRequest chatClientRequest, AdvisorChain advisorChain) {
        ...
        String question = template.render(Map.of("question", userQuestion));

        //доп запрос в LLM чтобы оформить более точный и полный запрос в векторную БД
        ...
        //коэффициент расширения запроса
